...
Begin VB.Form frmPing 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   5040
      OleObjectBlob   =   "frmPing.frx":000C
      Top             =   300
   End
...
'****************************************************************
'* Developer: Miguel Jeronimo                                   *
'* Date Last Modified: Quarta, Outubro 26, 2005                 *
'****************************************************************
Option Explicit
...
Dim Path As String
    ...
    frmPing.MousePointer = vbHourglass
...
On Error GoTo PortScanningError
Dim strTemp As String
Dim I As Integer
...
.sSendTo = "192.168.120.50" 'strTemp
...
Private Sub Form_Load()
    ...
    Skin1.ApplySkinByName teste.hwnd, "teste"
    'Skin1.LoadSkin App.Path & "\Web-II.skn" ' Loads another skin into Skin component
